...
window.onload = function () {
  ...
  function renderLightBG() {
    ...
    var grdLeft = lightBGCanvasContext.createRadialGradient(canvasWidth / 6 - 4, 64, 24, canvasWidth / 6 - 4, 72, 64);
    ...
    var grdMid = lightBGCanvasContext.createRadialGradient(canvasWidth / 2 - 30, 60, 24, canvasWidth / 2 - 30, 68, 64);
    ...
    var grdRight = lightBGCanvasContext.createRadialGradient(canvasWidth / 6 * 5 - 20, 64, 24, canvasWidth / 6 * 5 - 20, 72, 64);
